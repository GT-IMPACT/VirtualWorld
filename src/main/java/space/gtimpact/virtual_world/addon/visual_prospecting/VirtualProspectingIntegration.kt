...
object VirtualProspectingIntegration {
    ...
    internal val virtualOresL0Manager = VirtualOresLayerManager(0, virtualOresL0ButtonManager)
    internal val virtualOresL1Manager = VirtualOresLayerManager(1, virtualOresL1ButtonManager)
