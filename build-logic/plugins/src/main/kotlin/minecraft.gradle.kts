...
fun getManifestAttributes(): Map<String, Any> {
    ...
    if (coreModClass != null || useMixins) {
...
val mixinProviderGroup = "com.github.LegacyModdingMC.UniMixins"
val mixinProviderModule = "unimixins-mixin-1.7.10"
...
dependencies {
    if (useMixins) {
        ...
        kapt("com.google.guava:guava:24.1.1-jre")
        kapt("com.google.code.gson:gson:2.8.6")
